...
TEST_CASE("Collision detection functions", "[collision][math]") {
    ...
    SECTION("Rectangle to Rectangle Collision") {
        ...
        REQUIRE(RaylibStd::CheckCollisionRecs(rec1, rec2) == true);
        REQUIRE(RaylibStd::CheckCollisionRecs(rec1, rec3) == false);
    }
    ...
    SECTION("Get Collision Rectangle Intersection") {
        ...
        Rectangle overlap = RaylibStd::GetCollisionRec(rec1, rec2);
    ...
    SECTION("Point to Rectangle Collision") {
        ...
        REQUIRE(RaylibStd::CheckCollisionPointRec(pointInside, rec) == true);
        REQUIRE(RaylibStd::CheckCollisionPointRec(pointOutside, rec) == false);
    }
    ...
    SECTION("Circle to Circle Collision") {
        ...
        REQUIRE(RaylibStd::CheckCollisionCircles(center1, radius1, center2, radius2) == true);
        REQUIRE(RaylibStd::CheckCollisionCircles(center1, radius1, center3, radius3) == false);
    }
}